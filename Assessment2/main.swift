...
print("Please enter your fist name.")
var userFirstName = readLine()
print("Please enter your last name")
var userLastName = readLine()
...
var animals = ["penguins", "giraffe", "elephant", "tuna", "eagle"]
...
var carCDPlayer: String?

if let cdPlayer = carCDPlayer{
    print("This car has a \(cdPlayer) cd player")
}else{
    print("this car does not have a cd player")
}
